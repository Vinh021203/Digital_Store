...
const technologyIconPaths: Record<string, string> = {
  ...
  n8n: '/icons/n8n.svg',
  'google apps script': '/icons/google-apps-script.svg',
  'apps script': '/icons/google-apps-script.svg',
...
export const TECHNOLOGY_OPTIONS = [
  ...
  'jQuery', 'Figma', 'n8n', 'Google Apps Script', 'Laravel', 'PHP', 'Python', 'Django', 'Java', '.NET',
