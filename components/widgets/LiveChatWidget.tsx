...
export default function LiveChatWidget() {
    ...
    return (
        <>
            ...
            {isOpen && (
                <div
                    className={`fixed z-50 bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden transition-all duration-300 ${isMinimized
                ...
                >
                    ...
                    {!isMinimized && (
                        <>
                            {/* Messages */}
                            <div className="flex-1 h-[340px] overflow-y-auto p-4 space-y-4 bg-slate-50">
                                {messages.map(msg => (
